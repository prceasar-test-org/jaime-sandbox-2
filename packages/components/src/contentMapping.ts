...
const CollectionFiltered = dynamic(
  () => import('@jaime-sandbox-2/components/src/components/CollectionFiltered/CollectionFiltered')
);

// Custom components
const Quote = dynamic(() => import('@jaime-sandbox-2/components/src/components/Quote/Quote'));
const PageGeneral = dynamic(() => import('@jaime-sandbox-2/components/src/components/PageGeneral/PageGeneral'));
const PageBlog = dynamic(() => import('@jaime-sandbox-2/components/src/components/PageBlog/PageBlog'));
